	...
	Public Sub Load(ByVal skinFile As String, ByVal skinName As String)
		...
		For i As Integer = 0 To 1
			...
			Try
				...
				Drives(i).Image = { _
					New Bitmap(ini.ReadString(skinPathDrive & "xx", "")), _
					New Bitmap(ini.ReadString(skinPathDrive & "Rx", "")), _
					New Bitmap(ini.ReadString(skinPathDrive & "xW", "")), _
